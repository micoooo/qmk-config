...
tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Next Track, twice for Previous Track
    [NXT_PRV] = ACTION_TAP_DANCE_DOUBLE(KC_MNXT, KC_MPRV),
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  /* Base. Layer is setup for Windows; use karabiner for Mac.
   * ,-----------------------------------------------------------------------------------.
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Fkeys| Ctrl | GUI  | Alt  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
   * `-----------------------------------------------------------------------------------'
   */
  [_BASE] = LAYOUT_planck_mit(
    ...
    FKEYS,   KC_LCTL, KC_LGUI, KC_LALT, LOWER,       KC_SPC,       RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______,     _______,      _______,    TD(NXT_PRV), KC_VOLD, KC_VOLU, KC_MPLY
  ),
   ...
   * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   * |      |      |      |Aud on|Audoff|AGnorm|AGswap| Base |CapImg|CapMov|      |      |
   * |------+------+------+------+------+------|------+------+------+------+------+------|
  ...
  [_ADJUST] = LAYOUT_planck_mit(
    ...
    _______, _______, MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP,  BASE  , CAP_IMG, CAP_MOV, _______, _______,
